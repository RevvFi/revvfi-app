...
function AuctionCard({ auctionId, onSelect, selected }: { auctionId: number; onSelect: () => void; selected: boolean }) {
  ...
  if (isLoading || !auction) return <Skeleton className="h-32 w-full" />;
...
export default function AuctionsPage() {
  ...
  const allAuctionIds = [1]; // From backend seed data; in production you'd get these from liquidations endpoint
          ...
          <Card className="p-4">
            ...
            <div className="space-y-2">
              {[
                ...
                { label: "MEV Protection", desc: "RPC-endpoint integration active.", warn: true },
              ].map(({ label, desc, ok, warn }) => (
        ...
        <div className="space-y-4">
          <Card className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs text-on-surface-variant">Bids: 142</span>
            </div>
